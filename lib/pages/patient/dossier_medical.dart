...
class PatientDms extends StatelessWidget{
  @override
          ...
          children: [
            Center(
                child : Container(
                  ...
                  child: Text('Dossier Médical', style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, fontFamily: 'Arial Rounded MT Bold' ),
                  ),
                )
            ),
